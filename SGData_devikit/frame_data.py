...
class FrameBoxData(object):
    ...
    def load_waymo_dets_pkl(self, pkl_path, key="box3d_lidar"):
        ...
        if key != "box3d_lidar":
            ...
            self.label_names = [WAYMO_DT_LABEL_DICT[i] for i in labels]
